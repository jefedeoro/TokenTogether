    ...
    return (
      <main>
        ...
        <p style={{ textAlign: 'center', marginTop: '2.5em' }}>
          ...
          <h3>If you have a project in mind or just want to reserve your Token Name and Symbol.</h3>
          <br></br>
          <h2>You can mint as many as you want.</h2>
          <br></br>
          <h3>And thanks to the power of the NEAR blockchain they can be in your wallet within moments of reading this.</h3>
        </p>
        <h4>
          Please sign in or sign up now. The button
          below will bring you to NEAR Wallet.
        </h4>
